    ...
    function addDocumentControls() {
        ...
        var docControlsStr =
            ...
            <div id="document-controls">
                ...
                <button data-action="save" title="Download as HTML">Save HTML Temporary</button>
                <button data-action="print" title="Print">Print</button>
            </div>
            <div id="github-link">     
                <a class="github-button" href="https://github.com/shawpns" data-size="large" data-show-count="true" aria-label="Star Tombarr/html-resume-template on GitHub">Star</a>
            </div>`;
